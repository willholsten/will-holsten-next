...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var react_scrollable_anchor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-scrollable-anchor */ "./node_modules/react-scrollable-anchor/lib/index.js");
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Footer, [{
    ...
    value: function render() {
      ...
      }, "Will Holsten Ltd. \xA9 ", new Date().getFullYear(), " All Rights Reserved.")));
    }
  }]);
...
var FooterAvailability = /*#__PURE__*/function (_React$Component) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("ul", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("li", {
          ...
          className: _styles_scss__WEBPACK_IMPORTED_MODULE_9___default.a.textContainer
        }, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
        ...
        }, item.title), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_Button___WEBPACK_IMPORTED_MODULE_7__["default"], {
          link: item.slug,
          title: item.title,
...
module.exports = {
  theIdealSunday: __webpack_require__(/*! ./caseStudies/the-ideal-sunday.json */ "./data/caseStudies/the-ideal-sunday.json"),
  samsungBackstage: __webpack_require__(/*! ./caseStudies/samsung-backstage.json */ "./data/caseStudies/samsung-backstage.json"),
...
module.exports = {"slug":"id-mobile","title":"iD Mobile","url":"https://www.idmobile.co.uk","image":"../static/images/id-mobile.png","imageDevices":"../static/images/id-mobile-devices.png","background":"green-bg","summary":"iD Mobile is a mobile virtual network operating in the United Kingdom.","brief":"Upgrade the iD Mobile basket and checkout journey with a secure and testable solution.","work":["Working with designers to build a web solution based on their user journeys.","Consulting on UX best practises.","Building re-usable components using PHP Symfony framework.","Creating a global style guide that can be used by future development.","Working with Verifone - a third party payment API."],"technology":[{"id":1,"name":"HTML5","icon":"../static/vectors/technologies/html.svg"},{"id":2,"name":"Sass","icon":"../static/vectors/technologies/sass.svg"},{"id":3,"name":"Bootstrap","icon":"../static/vectors/technologies/bootstrap.svg"},{"id":4,"name":"jQuery","icon":"../static/vectors/technologies/jquery.svg"}]};
...
module.exports = {"slug":"samsung-backstage","title":"Samsung Backstage","url":"https://www.samsungbackstage.co.uk/","image":"../static/images/samsung-backstage.png","imageDevices":"../static/images/samsung-backstage-devices.png","background":"dark-purple-bg","summary":"Samsung Backstage","brief":"To build an e-learning platform to help Samsung exployees to sell products and services.","work":["Working with UX designers and back end developers to build the front end of the web app.","Creating courses and quizzes on the Totara e-learning platform.","Migrating existing landing pages to the new platform.","Working with various web services to keep account data in sync with the back end."],"technology":[{"id":1,"name":"HTML5","icon":"../static/vectors/technologies/html.svg"},{"id":2,"name":"Sass","icon":"../static/vectors/technologies/sass.svg"},{"id":3,"name":"React","icon":"../static/vectors/technologies/react.svg"},{"id":4,"name":"jQuery","icon":"../static/vectors/technologies/jquery.svg"}]};
...
module.exports = {"slug":"the-ideal-sunday","title":"The Ideal Sunday","url":"https://www.theidealsunday.com","image":"../static/images/the-ideal-sunday.png","imageDevices":"../static/images/the-ideal-sunday-devices.png","background":"black-bg","summary":"iD Mobile is a mobile virtual network operating in the United Kingdom.","brief":"Start an ecommerce business to raise awareness and help people find eco-friendly alternatives to everyday essentials","work":["Source products from ethical wholesalers.","Use eco-friendly, plastic free packaging.","Build a Shopify store and customise the theme."],"technology":[{"id":1,"name":"Shopify","icon":"../static/vectors/technologies/shopify.svg"}]};
...
module.exports = [{"name":"Adobe CC","icon":"../static/vectors/technologies/adobe-cc.svg"},{"name":"Atlassian","icon":"../static/vectors/technologies/atlassian.svg"},{"name":"Babel","icon":"../static/vectors/technologies/babel.svg"},{"name":"Bootstrap","icon":"../static/vectors/technologies/bootstrap.svg"},{"name":"CSS3","icon":"../static/vectors/technologies/css.svg"},{"name":"Gatsby js","icon":"../static/vectors/technologies/gatsby.svg"},{"name":"Git","icon":"../static/vectors/technologies/git.svg"},{"name":"HTML5","icon":"../static/vectors/technologies/html.svg"},{"name":"JavaScript","icon":"../static/vectors/technologies/javascript.svg"},{"name":"Jest","icon":"../static/vectors/technologies/jest.svg"},{"name":"jQuery","icon":"../static/vectors/technologies/jquery.svg"},{"name":"Material UI","icon":"../static/vectors/technologies/material-ui.svg"},{"name":"Next js","icon":"../static/vectors/technologies/nextjs.svg"},{"name":"NPM","icon":"../static/vectors/technologies/npm.svg"},{"name":"React","icon":"../static/vectors/technologies/react.svg"},{"name":"Redux","icon":"../static/vectors/technologies/redux.svg"},{"name":"Sass","icon":"../static/vectors/technologies/sass.svg"},{"name":"Shopify","icon":"../static/vectors/technologies/shopify.svg"},{"name":"Symfony","icon":"../static/vectors/technologies/symfony.svg"},{"name":"Webpack","icon":"../static/vectors/technologies/webpack.svg"}];
